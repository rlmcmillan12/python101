...
# def word_histogram(user_sentence, sorted_word_count_dict):
#     user_sentence_list = user_sentence.split()
#     word_count_dict = {}
#     for words in user_sentence_list:
#         if words not in word_count_dict:
...
# def top3Sorter(user_sentence, sorted_word_count_dict):
#     top3 = {}
#     for word in sorted_word_count_dict:
#         for word in sorted_word_count_dict:
#             top3[word] = user_sentence[word]
#     print(sorted_word_count_dict)


# user_sentence = input("Type a sentence and I will so my magic: ")
# sorted_word_count_dict = {}
# word_histogram(user_sentence, sorted_word_count_dict)
# top3Sorter(user_sentence, sorted_word_count_dict)
